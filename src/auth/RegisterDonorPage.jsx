    ...
    <div className="min-h-screen bg-gray-50 px-4 py-8">
      <div className="max-w-sm mx-auto">
        ...
        <div className="text-center mb-6">
          ...
          <h1 className="text-xl font-medium text-gray-900">Register as a donor</h1>
          <p className="text-sm text-gray-400 mt-1">Restaurants, hotels, marriage halls, hostels</p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5">
            ...
            <div className="border-t border-gray-100 pt-4 mt-2">
              <p className="text-xs font-medium text-gray-400 uppercase tracking-wide mb-4">Business details</p>
            </div>

            <div>
              <label className={labelClass}>Business name</label>
              <input placeholder="Hotel Sai Krishna" value={form.businessName} onChange={update('businessName')} required className={inputClass} />
            </div>
            ...
            <div>
              <label className={labelClass}>FSSAI license (optional)</label>
              <input placeholder="14-digit license number" value={form.fssaiLicense} onChange={update('fssaiLicense')} className={inputClass} />
            </div>
